...
export default function CodeCirculationMainPage() {
  return (
    <div className="min-h-screen">
        ...
        <div className="relative">
          ...
          <div
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div
                data-theme-card
                className="bg-slate-600 dark:bg-slate-700 blue:bg-blue-600 original:bg-indigo-600 p-4 rounded-lg opacity-70">
                <div className="flex justify-center mb-2">
                  <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center">
                    <Bike className="w-8 h-8 text-slate-700 dark:text-slate-800 blue:text-blue-700 original:text-indigo-700" />
                  </div>
                </div>
                <div className="text-center">
                  <h4 className="font-medium">الصنف أ - دراجات</h4>
                  <p className="text-sm text-gray-300">نارية ثقيلة</p>
                  <div className="mt-2 bg-primary text-primary-foreground blue:bg-white blue:text-blue-700 rounded-md py-1 px-2 text-sm">
                    Category A
                  </div>
                </div>
              ...
              <div
                ...
                <div className="flex justify-center mb-2">
                  <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center">
                    <Truck className="w-8 h-8 text-slate-700 dark:text-slate-800 blue:text-blue-700 original:text-indigo-700" />
                  </div>
                </div>
                <div className="text-center">
                  <h4 className="font-medium">الصنف ج+هـ - سيارات</h4>
                  <p className="text-sm text-gray-300">نقل ثقيلة</p>
                  <div className="mt-2 bg-primary text-primary-foreground blue:bg-white blue:text-blue-700 rounded-md py-1 px-2 text-sm">
                    Category C+E
                  </div>
                </div>
              ...
              <div
                ...
                <div className="text-center">
                  <h4 className="font-medium">الصنف أ - دراجات</h4>
                  <p className="text-sm text-gray-300">نارية</p>
                  <div className="mt-2 bg-primary text-primary-foreground blue:bg-white blue:text-blue-700 rounded-md py-1 px-2 text-sm">
                    Category A
                  </div>
                </div>
      ...
      <section className="container mx-auto py-16 px-4 grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="relative order-1 md:order-2">
          <div className="absolute top-0 left-8 text-primary text-4xl">✦</div>
          <div
            data-theme-container
            className="bg-slate-700 dark:bg-slate-800 blue:bg-blue-700 original:bg-indigo-700 rounded-lg p-4 max-w-md mx-auto">
            <div
            ...
            <div
              data-theme-card
              className="bg-slate-600 dark:bg-slate-700 blue:bg-blue-600 original:bg-indigo-600 p-4 rounded-lg mb-4">
            ...
            <div
              ...
              <div
                data-theme-header
                className="bg-slate-800 dark:bg-slate-900 blue:bg-blue-800 original:bg-indigo-800 rounded-lg h-32 mb-2 flex items-center justify-center">
          ...
          <div className="grid grid-cols-2 gap-4 max-w-md mx-auto">
            ...
            <div
              ...
              <div className="space-y-2">
                <div
                  data-theme-card
                  className="bg-slate-600 dark:bg-slate-700 blue:bg-blue-600 original:bg-indigo-600 p-2 rounded-lg text-center text-sm">
