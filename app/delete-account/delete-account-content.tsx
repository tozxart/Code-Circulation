          ...
          {isEnglish ? (
            <>
              ...
              <p className="mb-6 text-muted-foreground">
                You can delete your <strong>Royal Joker</strong> account and
              ...
              <section className="mb-8">
                ...
                <ol className="list-decimal pl-6 space-y-2 text-muted-foreground">
                  ...
                  <li>
                    Read the confirmation and tap Delete my account to confirm.
                  </li>
                </ol>
                <p className="mt-4 text-muted-foreground">
                  Your account and data are deleted immediately. You will be
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  <li>
                    Your profile (display name, avatar, background, coins, gems,
                    level, loadout).
                  </li>
                  ...
                  <li>
                    Your tournament entries and any tournaments you created
                    (tournament data may be anonymized where you were a
                    participant).
                  </li>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground">
                  We do not retain your account or the above data after
                  deletion. Backups may hold data for a short retention period
                  (up to 30 days) before it is purged; we do not use that data
                  for any purpose after your deletion request.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground">
                  If you cannot delete your account from the app (for example,
                  you no longer have access to the device), contact us with your
                  app/developer name and we will process your request.
                </p>
              </section>
            ...
            <>
              ...
              <p className="mb-6 text-muted-foreground text-right">
                يمكنك حذف حساب <strong>Royal Joker</strong> والبيانات المرتبطة
                به في أي وقت.
              </p>

              <section className="mb-8 text-right">
                <h2 className="text-2xl font-bold mb-4">
                  طريقة حذف الحساب من داخل التطبيق
                </h2>
                <ol className="list-decimal pr-6 space-y-2 text-muted-foreground text-right">
                  <li>افتح تطبيق Royal Joker.</li>
                  <li>
                    ادخل إلى الإعدادات (رمز الترس أو من القائمة الرئيسية).
                  </li>
                ...
                <p className="mt-4 text-muted-foreground">
                  يتم حذف الحساب والبيانات مباشرة، ثم يتم إعادتك إلى شاشة تسجيل
                  الدخول.
                </p>
              </section>
              ...
              <section className="mb-8 text-right">
                ...
                <p className="mb-3 text-muted-foreground">
                  عند حذف حسابك، نقوم بحذف ما يلي بشكل دائم:
                </p>
                <ul className="list-disc pr-6 space-y-2 text-muted-foreground text-right">
                  <li>
                    الملف الشخصي (الاسم، الصورة، الخلفية، العملات، الجواهر،
                    المستوى، التجهيزات).
                  </li>
                  ...
                  <li>
                    مشاركات البطولات والبطولات التي أنشأتها (قد تُحوَّل بعض
                    بيانات البطولات إلى صيغة مجهولة إذا كنت مشاركًا).
                  </li>
              ...
              <section className="mb-8 text-right">
                ...
                <p className="text-muted-foreground">
                  لا نحتفظ بالحساب أو البيانات المذكورة بعد الحذف. قد تبقى
                  البيانات في النسخ الاحتياطية لفترة قصيرة (حتى 30 يومًا) قبل
                  الإزالة النهائية، ولا يتم استخدامها بعد طلب الحذف.
                </p>
              </section>
              ...
              <section className="mb-8 text-right">
                ...
                <p className="text-muted-foreground">
                  إذا لم تتمكن من حذف الحساب من داخل التطبيق (مثل فقدان الوصول
                  إلى الجهاز)، تواصل معنا مع اسم التطبيق/المطور وسنقوم بمعالجة
                  طلبك.
                </p>
              </section>

              <p className="text-muted-foreground italic text-right">
                Royal Joker
              </p>
            </>
          )}
