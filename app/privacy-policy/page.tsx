  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-600 to-blue-500 text-white">
      ...
      <div className="container mx-auto flex justify-center mt-4">
        <Link
          href="/"
          className="bg-white text-blue-600 hover:bg-blue-50 px-6 py-2 rounded-md font-medium transition-colors shadow">
          عودة للرئيسية
        </Link>
      </div>

      <main className="container mx-auto py-8 px-4 text-center">
        <div className="max-w-3xl mx-auto bg-blue-700 rounded-lg p-8 shadow-lg">
          <h1 className="text-3xl font-bold mb-6">
            سياسة الخصوصية لتطبيق Code Circulation
          </h1>
          <p className="text-blue-200 mb-8 text-right">
          ...
          <section className="mb-8 text-right">
            ...
            <ul className="list-disc pr-6 mb-4 space-y-2 text-blue-100 text-right">
      ...
      <div className="container mx-auto relative">
        <div className="absolute -top-10 left-10 w-16 h-16 text-blue-300 opacity-50 text-4xl">
          ✦
        </div>
        <div className="absolute -bottom-10 right-10 w-16 h-16 text-blue-300 opacity-50 text-4xl">
          ✦
        </div>
      </div>
    </div>
