            ...
            {isEnglish ? (
              <>
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4 text-muted-foreground">
                    This Privacy Policy describes how Royal Joker handles
                    account and game-related data.
                  </p>
                </section>
                <section className="mb-8">
                  <h2 className="text-2xl font-bold mb-4">Data Use</h2>
                  <p className="mb-4 text-muted-foreground">
                    We use account data to provide gameplay features such as
                    profile, progression, friends, and matchmaking.
                  </p>
                </section>
                <section className="mb-8">
                  <h2 className="text-2xl font-bold mb-4">Account Deletion</h2>
                  <p className="mb-4 text-muted-foreground">
                    You can request account deletion any time from inside the
                    app. For full steps and retention details, visit:
                  </p>
                  <Link
              ...
              <>
                ...
                <section className="mb-8 text-right">
                  ...
                  <p className="mb-4 text-muted-foreground">
                    توضح سياسة الخصوصية هذه كيفية تعامل Royal Joker مع بيانات
                    الحساب واللعبة.
                  </p>
                </section>
                <section className="mb-8 text-right">
                  ...
                  <p className="mb-4 text-muted-foreground">
                    نستخدم بيانات الحساب لتقديم ميزات اللعب مثل الملف الشخصي،
                    التقدم، الأصدقاء، والمطابقة.
                  </p>
                </section>
                <section className="mb-8 text-right">
                  <h2 className="text-2xl font-bold mb-4">حذف الحساب</h2>
                  <p className="mb-4 text-muted-foreground">
                    يمكنك طلب حذف الحساب في أي وقت من داخل التطبيق. للاطلاع على
                    الخطوات الكاملة وفترة الاحتفاظ، زر الصفحة التالية:
                  </p>
                  <Link
                    href="/delete-account"
                    className="text-primary hover:underline">
    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto py-8 px-4 text-center">
        <div className="max-w-3xl mx-auto bg-card rounded-lg p-8 shadow-lg">
          <h1 className="text-3xl font-bold mb-6">
            سياسة الخصوصية لتطبيق Code Circulation
          </h1>
          <p className="text-muted-foreground mb-8 text-right">
          ...
          <section className="mb-8 text-right">
            <h2 className="text-2xl font-bold mb-4">مقدمة</h2>
            <p className="mb-4 text-muted-foreground">
              تصف سياسة الخصوصية هذه كيفية تعامل تطبيق Code Circulation ("نحن"
              أو "لنا") مع خصوصية المستخدم. تم تصميم هذا التطبيق للعمل دون جمع
              أي معلومات شخصية من مستخدميه.
            </p>
          </section>
          ...
          <section className="mb-8 text-right">
            ...
            <p className="mb-4 text-muted-foreground">
              هذا التطبيق غير تابع لأي جهة حكومية. تم تطويره كمبادرة تعليمية
              مستقلة، وجميع المعلومات الواردة مستمدة من "مجلة الطرقات التونسية"
              والمصادر الرسمية المتاحة للجمهور.
            </p>
          </section>
          ...
          <section className="mb-8 text-right">
            ...
            <p className="mb-4 text-muted-foreground">
              <strong>تطبيق Code Circulation لا يجمع أي بيانات شخصية.</strong>{" "}
              نحن لا نقوم بـ:
            </p>
          ...
          <section className="mb-8 text-right">
            ...
            <p className="mb-4 text-muted-foreground">
              تطبيقنا لا يجمع معلومات شخصية من أي شخص، بما في ذلك الأطفال دون سن
              13 عامًا.
            </p>
          </section>
